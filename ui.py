...
class QuizInterface:
    ...
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.true_button = Button(image=right_image, highlightthickness=0, activebackground=THEME_COLOR, bd=0, command=self.true_ans)
        self.true_button.grid(row=2, column=0)
        self.false_button = Button(image=false_image, highlightthickness=0, activebackground=THEME_COLOR, bd=0, command=self.false_ans)
